...
class ChecklistVM: ObservableObject {
    ...
    @Published var items = [
        ...
        ChecklistItem(name: "Standardized Test Scores", description: "Many colleges require either SAT or ACT scores, which are standardized tests that measure a student's proficiency in reading, writing, and math."),
        ...
        ChecklistItem(name: "Extracurricular Activities", description: "This is a list of all the clubs, sports, volunteer work, or other activities you participated in outside of the classroom."),
